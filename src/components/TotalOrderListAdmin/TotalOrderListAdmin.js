...
const TotalOrderListAdmin = ({ item, onPress }) => {
    ...
    <View style={styles.container}>
      <View style={styles.innerRow}>
        ...
        <View style={styles.timeDateContainer}>
          ...
          <Text style={styles.secondaryTextSm}>{getTime(item?.dateTime)}</Text>
        </View>
      </View>
      {item?.name && (
        <View style={styles.innerRow}>
      ...
      <View style={styles.innerRow}>
        ...
        <Text style={styles.secondaryText}>Total Amount : ₹ {item?.totalAmount}</Text>
      </View>
      <View style={styles.innerRow}>
...
export default TotalOrderListAdmin;
